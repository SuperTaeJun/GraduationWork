...
//void ACharacterController::SetNewCharacterInfo(shared_ptr<CPlayer> InitPlayer)
//{
...
//
//	//	PlayersInfo->players[NewPlayer.front()->Id] = info;
//	//	count = PlayersInfo->players.size();
//	//}
//
